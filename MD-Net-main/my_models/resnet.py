        ...
        if comb_method is not None:
            ...
            if comb_method == 'metablock':
                ...
                if isinstance(comb_config, int):
                    ...
                    self.comb_feat_maps1 = 64
                    self.comb = NetBlock(comb_config, 64, 32,self.comb_feat_maps1,comb_config)
                elif isinstance(comb_config, list):
                    self.comb = NetBlock(comb_config[0], comb_config[1], comb_config[2],self.comb_feat_maps1,comb_config[1])
