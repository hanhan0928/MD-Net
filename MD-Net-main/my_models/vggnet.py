        ...
        if comb_method is not None:
            ...
            if comb_method == 'metablock':
                if isinstance(comb_config, int):
                    ...
                    # 本人改進的部分，將metanet與metablock結合
            elif comb_method == 'netblock':
                    if isinstance(comb_config, int):
                        self.comb_feat_maps = 392
                        self.comb_feat_maps1 = 784
                        self.comb = NetBlock(comb_config, 64, 392, self.comb_feat_maps1, comb_config)
                    elif isinstance(comb_config, list):
                ...
                if isinstance(comb_config, int):
                    self.comb_feat_maps = 392
                    self.comb = MetaNet(comb_config, 64, 392)
                elif isinstance(comb_config, list):
